...
# Cell 1: Markdown - Header, Metadata, and Documented Official Data Sources
...
# Cell 2: Python Imports and Visual Configuration
...
# Cell 3: US BLS Employment & Growth Data (2020-2026 + 2034 Projection)
cell3 = nbf.v4.new_code_cell("""# Cell 3: Dataset 1 — US Bureau of Labor Statistics (BLS) Tech Employment Trends & AI Exposure
# Data Sourced from US BLS Occupational Projections & OEWS Reports (2020 - 2026 Actuals, 2034 Projections)
...
# Visualization 1: Employment Growth vs AI Adoption Curve (US BLS)
...
# Cell 4: Canada Statistics Canada (StatCan) TechStat & Job Market Shift Data
cell4 = nbf.v4.new_code_cell("""# Cell 4: Dataset 2 — Statistics Canada (StatCan TechStat Initiative & LFS Data)
# Analyzing Enterprise AI Adoption & Demand Shift between Entry-Level and Senior Roles
...
# Interactive Plotly Chart: Junior vs Senior Developer Hiring Demand Index in Canada
fig_can = go.Figure()
...
# Cell 5: Eurostat & OECD ICT Specialists & Task Exposure Index
cell5 = nbf.v4.new_code_cell("""# Cell 5: Dataset 3 — Eurostat & OECD ICT Workforce & AI Task Exposure Metrics
# Data Sourced from Eurostat ICT Employment & OECD AI Exposure Index (2018–2026)
...
# Heatmap of OECD AI Task Exposure Across Data Roles
...
# Cell 6: Stack Overflow & GitHub Dev Surveys Time Allocation Shift
cell6 = nbf.v4.new_code_cell("""# Cell 6: Dataset 4 — Stack Overflow & GitHub Developer Surveys (2020 vs 2026)
# Measuring the Transformation of Daily Developer Work Breakdown
...
# Comparison Bar Chart of Time Allocation Shift
...
# Cell 7: Econometric Summary & Regional Impact Comparison Matrix (FIXED & ENHANCED)
cell7 = nbf.v4.new_code_cell("""# Cell 7: Econometric Summary & Regional Impact Comparison Matrix
from IPython.display import display, HTML
import pandas as pd
import numpy as np
import plotly.graph_objects as go
...
# Cell 8: Executive Summary & Key Strategic Conclusions
cell8 = nbf.v4.new_markdown_cell("""# 📌 Executive Summary & Key Research Findings
...
print(f"Notebook successfully generated at: {target_file}")
