...
# Cell 1: Markdown - Part 1: Main Title, Metadata, Key Insights, and Official Data Sources
...
## 💡 Part 1: Key Executive Insights & Core Takeaways

* 📈 **Task Augmentation Over Job Displacement**: Empirical statistics across the US, Canada, and Europe demonstrate that AI models act as productivity multipliers rather than workforce eliminators. U.S. Bureau of Labor Statistics (BLS) projects **+15.8% developer employment growth (2024–2034)**, much faster than average.
* ⚖️ **The "Junior Squeeze" vs. Senior Demand**: Statistics Canada (**StatCan TechStat**) data reveals a structural divergence: entry-level job posting indices fell by **-34%** (from 100 in 2020 to 66 in 2026) due to automated code generation, while senior architect demand surged by **+46%** (index 146 in 2026).
* 🚀 **Widespread AI Tool Integration**: Global developer benchmarks (**Stack Overflow & GitHub**) show active AI tool usage exploded from **3.1% in 2020** to **85.3% in 2026**.
* 🏗️ **Upward Shift in the Value Chain**: Data developers spend **70% less time writing raw boilerplate code** and **75% more time on system architecture, data modeling, code review, and AI governance**.
...
# Cell 2: Code - Part 2: Environment Setup & Library Imports
cell2 = nbf.v4.new_code_cell("""# Cell 2: Setup & Environment Initialization (Part 2)
import pandas as pd
import numpy as np
...
# Configure Plotly renderer for notebook compatibility
...
# Cell 3: Markdown - Part 3: United States BLS Employment Intro
cell3 = nbf.v4.new_markdown_cell("""## 3. United States: BLS Employment Growth & AI Adoption Trajectory (2020–2034)
Analyzing employment numbers, median wage trajectories, and AI tool adoption among US software and data developers.
""")

# Cell 4: Code - Part 4: US BLS Dataframe & Dual-Axis Visualization
cell4 = nbf.v4.new_code_cell("""# Cell 4: US BLS Tech Employment Trends & Dual-Axis Visualization (Part 4)
bls_data = {
...
# Cell 5: Markdown - Part 5: Canada StatCan Section Intro
cell5 = nbf.v4.new_markdown_cell("""## 5. Canada: Statistics Canada TechStat & Experience Level Hiring Divergence
...
# Cell 6: Code - Part 6: Canada StatCan Analysis & Dual Subplots
cell6 = nbf.v4.new_code_cell("""# Cell 6: Canada StatCan TechStat Initiative & Job Demand Dynamics (Part 6)
...
# 2. Interactive Plotly Dual Subplots
...
# Cell 7: Markdown - Part 7: Europe Eurostat & OECD Section Intro
cell7 = nbf.v4.new_markdown_cell("""## 7. Europe: Eurostat ICT Workforce Growth & OECD Task Exposure Index
Analyzing European Union ICT workforce growth (10.8M in 2026) and OECD task-level AI exposure across data roles.
""")

# Cell 8: Code - Part 8: Eurostat & OECD Analysis & Heatmap
cell8 = nbf.v4.new_code_cell("""# Cell 8: Eurostat ICT Workforce & OECD Task Exposure Heatmap (Part 8)
eurostat_ict_data = {
...
# Cell 9: Markdown - Part 9: Global Developer Surveys Intro
cell9 = nbf.v4.new_markdown_cell("""## 9. Global Developer Surveys: Workflow Transformation (2020 vs 2026)
Measuring the evolution of daily time allocation among developers before and after modern LLM adoption.
""")

# Cell 10: Code - Part 10: Stack Overflow & GitHub Surveys Time Shift Chart
cell10 = nbf.v4.new_code_cell("""# Cell 10: Stack Overflow & GitHub Surveys Time Allocation Shift (Part 10)
...
# Cell 11: Markdown - Part 11: Synthesis Section Intro
cell11 = nbf.v4.new_markdown_cell("""## 11. Econometric Synthesis & Regional Impact Comparison Matrix
Consolidating key stats across the US, Canada, EU, and global developer surveys into a comparative summary and visual chart.
""")

# Cell 12: Code - Part 12: Econometric Summary Table & Interactive Plotly Regional Bar Chart
cell12 = nbf.v4.new_code_cell("""# Cell 12: Econometric Summary & Regional Impact Comparison Matrix (Part 12)
from IPython.display import display, HTML
import pandas as pd
import numpy as np
import plotly.graph_objects as go
...
# Cell 13: Code - Part 13: Interactive KPI Executive Dashboard & Work Breakdown Donut Chart
cell13 = nbf.v4.new_code_cell("""# Cell 13: Executive KPI Dashboard & Strategic Work Breakdown Visualization (Part 13)
from IPython.display import display, HTML
import pandas as pd
import plotly.graph_objects as go
...
# Cell 14: Code - Part 14: Automated Dataset Export & Analysis Synthesis Confirmation
cell14_lines = [
    "# Cell 14: Automated Dataset Export & Analysis Synthesis Confirmation (Part 14)",
    "import os",
    "import pandas as pd",
    "from IPython.display import display, HTML",
    "",
...
# Ensure metadata and execution counts are clean
...
print(f"Resorted 14-Cell Notebook successfully generated at: {target_file}")
